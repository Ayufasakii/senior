            ...
            <v-list-item-group v-model="group" active-class="deep-purple--text text--accent-4">
                ...
                <nuxt-link class="nuxt-link" to="/SCT">
                    <v-list-item>
                        ...
                        <v-list-item-title>Create teacher account</v-list-item-title>
                    </v-list-item>
                </nuxt-link>

                <nuxt-link class="nuxt-link" to="/SSI">
                    <v-list-item>
                        <v-list-item-icon>
                ...
                <nuxt-link class="nuxt-link" to="/STI">
                    <v-list-item>
                        <v-list-item-icon>
                            <v-icon>mdi-account-search</v-icon>
                        </v-list-item-icon>
                        <v-list-item-title>Teacher information</v-list-item-title>
                    </v-list-item>
                </nuxt-link>
